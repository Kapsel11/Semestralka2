...
namespace structures
{
	...
	{
		//TODO 03: ArrayList
		DSRoutines::rangeCheckExcept(index, size_, "Neplatny index!");
		//T mazany = (*array_)[index];
		T mazany = (*this)[index];
	...
	{
		//TODO 03: ArrayList
		Array<T>* nove = new Array<T>(2 * array_->size());
		Array<T>::copy(*array_, 0, *nove, 0, size_);
		delete array_;
		array_ = nove;
	}
	...
	template<typename T>
	void ArrayList<T>::set(const int index, const T& data) {
